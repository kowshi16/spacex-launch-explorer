  ...
  return (
    <div className="bg-gradient-to-br from-white to-gray-50 rounded-2xl shadow-xl p-4 sm:p-6 mb-8 max-w-7xl mx-auto border border-gray-200">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
        ...
        <div className="relative">
          ...
          <div className="relative">
            ...
            <CalendarMonthOutlined className="absolute left-3 top-1/2 transform -translate-y-1/2 h-5 w-5 text-gray-400" />
          </div>
        </div>
        ...
        <div className="relative">
          ...
          <div className="relative">
            ...
            <ChangeCircleOutlined className="absolute left-3 top-1/2 transform -translate-y-1/2 h-5 w-5 text-gray-400" />
          </div>
        </div>
        ...
        <div className="relative">
          ...
          <div className="relative">
            ...
            <SwapVertOutlined className="absolute left-3 top-1/2 transform -translate-y-1/2 h-5 w-5 text-gray-400" />
          </div>
        </div>
        ...
        <div className="relative">
          ...
          <div className="relative flex items-center h-10">
            <input
              ...
              onChange={(e) =>
                onFilterChange("favoritesOnly", e.target.checked)
              }
      ...
      <div className="mt-4 flex justify-end">
        ...
        >
          <RestartAltOutlined className="mr-2 h-5 w-5" />
          Reset Filters
        </button>
      </div>
    </div>
